      ...
      <header className="w-full top-0 sticky bg-surface border-b border-outline-variant z-50">
        <div className="grid grid-cols-2 md:grid-cols-3 items-center px-4 py-4 w-full max-w-7xl mx-auto">
          ...
          <nav className="hidden md:flex justify-center items-center gap-8 font-label-lg text-label-lg">
            <a className="text-primary border-b-[3px] border-primary pb-1 cursor-pointer" href="#">{t('landing.market')}</a>
            <a className="text-on-surface-variant hover:text-primary transition-colors cursor-pointer" href="#">{t('landing.episodes')}</a>
            <a className="text-on-surface-variant hover:text-primary transition-colors cursor-pointer" href="#">{t('landing.advisory')}</a>
          </nav>
      ...
      <main>
        ...
        <section className="bg-[#f7f7f5] py-12">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col gap-2 mb-8 text-center md:text-left">
              <span className="text-secondary font-label-lg text-label-lg uppercase tracking-widest">{t('landing.services.subtitle')}</span>
              <h2 className="font-display-md text-display-md text-on-surface">{t('landing.services.title')}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div onClick={() => navigate('/register')} className="bg-white border border-outline-variant p-6 rounded-xl flex flex-col gap-4 hover:shadow-md hover:-translate-y-1 transition-all cursor-pointer group">
                ...
                <h3 className="font-title-md text-title-md text-primary">{t('landing.role.farmer.title')}</h3>
                <p className="font-body-md text-body-md text-on-surface-variant">{t('landing.role.farmer.desc')}</p>
                <div className="mt-auto pt-4 flex items-center gap-1 text-primary font-label-lg group-hover:gap-2 transition-all">
                  <span>{t('landing.role.farmer.action')}</span>
              ...
              <div onClick={() => navigate('/register')} className="bg-white border border-outline-variant p-6 rounded-xl flex flex-col gap-4 hover:shadow-md hover:-translate-y-1 transition-all cursor-pointer group">
                ...
                <h3 className="font-title-md text-title-md text-primary">{t('landing.role.buyer.title')}</h3>
                <p className="font-body-md text-body-md text-on-surface-variant">{t('landing.role.buyer.desc')}</p>
                <div className="mt-auto pt-4 flex items-center gap-1 text-primary font-label-lg group-hover:gap-2 transition-all">
                  <span>{t('landing.role.buyer.action')}</span>
                  <span className="material-symbols-outlined text-sm">arrow_forward</span>
                </div>
              </div>
              ...
              <div onClick={() => navigate('/login')} className="bg-white border border-outline-variant p-6 rounded-xl flex flex-col gap-4 hover:shadow-md hover:-translate-y-1 transition-all cursor-pointer group">
                ...
                <h3 className="font-title-md text-title-md text-primary">{t('landing.role.officer.title')}</h3>
                <p className="font-body-md text-body-md text-on-surface-variant">{t('landing.role.officer.desc')}</p>
                <div className="mt-auto pt-4 flex items-center gap-1 text-primary font-label-lg group-hover:gap-2 transition-all">
                  <span>{t('landing.role.officer.action')}</span>
                  <span className="material-symbols-outlined text-sm">arrow_forward</span>
                </div>
              </div>
              ...
              <div onClick={() => navigate('/login')} className="bg-white border border-outline-variant p-6 rounded-xl flex flex-col gap-4 hover:shadow-md hover:-translate-y-1 transition-all cursor-pointer group">
                ...
                <h3 className="font-title-md text-title-md text-primary">{t('landing.role.admin.title')}</h3>
                <p className="font-body-md text-body-md text-on-surface-variant">{t('landing.role.admin.desc')}</p>
                <div className="mt-auto pt-4 flex items-center gap-1 text-primary font-label-lg group-hover:gap-2 transition-all">
                  <span>{t('landing.role.admin.action')}</span>
                  <span className="material-symbols-outlined text-sm">arrow_forward</span>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center md:border-r border-outline-variant last:border-none">
                ...
                <div className="text-label-lg text-on-surface-variant">{t('landing.stats.active_farmers')}</div>
              </div>
              <div className="text-center md:border-r border-outline-variant last:border-none">
                <div className="text-display-md font-bold text-primary">TZS 12B</div>
                <div className="text-label-lg text-on-surface-variant">{t('landing.stats.market_tx')}</div>
              </div>
              <div className="text-center md:border-r border-outline-variant last:border-none">
                <div className="text-display-md font-bold text-primary">26</div>
                <div className="text-label-lg text-on-surface-variant">{t('landing.stats.tanzania_regions')}</div>
              </div>
              <div className="text-center border-none">
                <div className="text-display-md font-bold text-primary">150+</div>
                <div className="text-label-lg text-on-surface-variant">{t('landing.stats.ext_officers')}</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-surface py-12">
          <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2 flex flex-col gap-4">
              <span className="text-secondary font-label-lg text-label-lg">{t('landing.guide.tag')}</span>
              <h2 className="font-display-md text-display-md text-on-surface">{t('landing.guide.title')}</h2>
              ...
              <ul className="flex flex-col gap-2 mt-2">
                <li className="flex items-start gap-2 font-body-md text-body-md">
                  ...
                  <span>{t('landing.guide.bullet1')}</span>
                </li>
                <li className="flex items-start gap-2 font-body-md text-body-md">
                  <span className="material-symbols-outlined text-primary">check_circle</span>
                  <span>{t('landing.guide.bullet2')}</span>
                </li>
                <li className="flex items-start gap-2 font-body-md text-body-md">
                  <span className="material-symbols-outlined text-primary">check_circle</span>
                  <span>{t('landing.guide.bullet3')}</span>
                </li>
              </ul>
        ...
        <section className="bg-[#f7f7f5] py-12 border-y border-outline-variant">
          <div className="max-w-3xl mx-auto text-center px-4 flex flex-col gap-6">
            <h2 className="font-display-md text-display-md text-primary">{t('landing.cta.title')}</h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant">
              {t('landing.cta.desc')}
            </p>
      ...
      <footer className="w-full mt-auto bg-inverse-surface">
        <div className="flex flex-col md:flex-row justify-between items-center px-4 py-8 w-full max-w-7xl mx-auto gap-6">
          ...
          <nav className="flex flex-wrap justify-center gap-6 font-label-sm text-label-sm">
            <a className="text-on-surface-variant opacity-80 hover:text-primary-fixed transition-colors underline-offset-4 hover:underline" href="#">{t('landing.footer.privacy')}</a>
            <a className="text-on-surface-variant opacity-80 hover:text-primary-fixed transition-colors underline-offset-4 hover:underline" href="#">{t('landing.footer.legal')}</a>
            <a className="text-on-surface-variant opacity-80 hover:text-primary-fixed transition-colors underline-offset-4 hover:underline" href="#">{t('landing.footer.contact')}</a>
          </nav>
